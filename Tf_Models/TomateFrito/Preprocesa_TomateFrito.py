...
def Preprocesa_TomateFrito(archivo):
    try:
        df=archivo
        ...
        columnas_a_eliminar = [col for col in df.columns if col not in ['Sample', 'H2(SGP30)', 'SRAW(SGP40)', 'Ethanol(SGP30)', 'Air/Sample','tOUT_PID-AH2']]
